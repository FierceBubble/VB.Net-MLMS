...
Public Class EditStaffInfoMainMenu
    ...
    Private Sub EditPersonalInfo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If count = 1 Then
                Dim CID As String = rdr("StaffID")
                EditGender = rdr("Gender")
                Dim CDOB As Date = rdr("DOB")

                EditIDBox.Text = CID
                EditFNameBox.Text = SignIn.COSFName
                EditLNameBox.Text = SignIn.COSLName
    ...
    Private Sub SaveEdit_Click(sender As Object, e As EventArgs) Handles SaveEdit.Click
        ...
        Else
            ...
            Try
                ...
                'Customer will be forwarded to the "SignIn page" to re-SignIn with their new personal information'
                Me.Close()
                SignIn.Show()
            Catch ex As MySqlException
                MessageBox.Show(ex.Message)
